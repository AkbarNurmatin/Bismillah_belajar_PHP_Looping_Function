...
<body>
    ...
    <?php 
        ...
        */
        ...
        // Output: 
        foreach($items as $asosiatif => $nama_perangkat) {
            $hasil = [
                'id' => $nama_perangkat[0],
                'name' => $nama_perangkat[1],
                'price' => $nama_perangkat[2],
                'description' => $nama_perangkat[3],
                'source' => $nama_perangkat[4]
            ];
            print_r($hasil);
            echo "<br>";
        }
